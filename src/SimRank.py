...
class SimRank(object):
    """
    Basic class of the SimRank algorithm. Calculatse the similarities between the
    ...
    def _create_graph(self, data, weighted, from_node_column, to_node_column, weight_column):
        ...
        """
        self.Nodes = list(set(data[from_node_column].unique()) | set(data[to_node_column].unique()))
